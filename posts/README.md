...
- [Ubuntu 网络配置实战：Clash + Samba + USB4 双机互联](03-ubuntu-network-setup.md)
- [本地大模型运行时完全指南：LM Studio / Ollama / vLLM / llama.cpp RPC](04-llm-runtime-guide.md)
- [量化金融场景的本地大模型选型指南](05-llm-model-selection.md)
